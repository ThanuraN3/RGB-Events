						...
						<div class="container">
							<div class="slider-item-content">
								...
								<div class="link-groups">
									<a href="about.php" class="about-btn custom-btn">about us</a>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="section-title text-left">
										<span class="line-style"></span>
										<small class="sub-title">RGB EVENTS</small>
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="tab-menu">
										...
										<div class="event-makeing-btn">
											<a href="#!">
												<strong class="yellow-color" id="viewall">VIEW ALL</strong>
											</a>
										</div>
									</div>
								</div>
		...
		<section id="advertisement-section" class="advertisement-section clearfix" style="background-image: url(assets/images/special-offer-bg.jpg);">
			<div class="container">
				<div class="advertisement-content text-center">
					...
					<p class="mb-31">“Get started now, RGB Events event management.”</p>
							...
							<div class="card">
								<div class="card-header" id="headingone">
									<button class="btn collapsed" data-toggle="collapse" data-target="#collapseone" aria-expanded="true" aria-controls="collapseone">
										<span>01.</span> How to join RGB Event Management?
									</button>
								</div>
