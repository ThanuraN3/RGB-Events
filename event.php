				...
				<div class="service-wrapper">
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Conference and <strong>Meeting</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">Awards <strong>Ceremony</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Product <strong>Launch </strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">RGB Events <strong>Exhibitions</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Dealer <strong>Convention</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">Opening <strong>Ceremonies</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Press <strong>Conferences</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">Sport <strong>Events</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Fashion <strong>show</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">Brand Activations <strong>& Promotions</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Public and <strong>Private Events</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">RGB <strong>Seminas</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-right">
							<div class="service-title mb-30">
								<h2 class="title-text">Conference <strong>and meetings</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
					...
					<div class="service-item clearfix">
						...
						<div class="service-content float-left">
							<div class="service-title mb-30">
								<h2 class="title-text">Outbound <strong>Training</strong></h2>
								<span class="service-price">Planning an inspiring event</span>
							</div>
							<p class="service-description black-color mb-30">
								Lorem ipsum dollor site amet the best  consectuer diam adipiscing elites sed diam nonummy nibh the euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit. 
